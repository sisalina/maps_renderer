...
lat_est_salida  = est13[0]
lon_est_salida  = est13[1]

lat_est_llegada = est13[0]
lon_est_llegada = est13[1]

a_mistakes = 0

for track_id in range(2618,8200):
	...
	try:
		...
		for row in rows:
			...
			if dif_salida < 500 and dif_llegada < 500:
				print str(track_id)
